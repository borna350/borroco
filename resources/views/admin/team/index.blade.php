        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="{{ route('team.create') }}" class="btn btn-raised btn-info -mt5 btn-sm btn-round waves-effect">
                    ...
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($team->image)
                                        <img src="{{ asset('media/team/'. $team->image) }}" width="50">
                                    @endif
                                </td>
                                <td>{{ $team->name }}</td>
                                ...
                                <td class="p-1">
                                    ...
                                    <form action="{{ route('team.destroy', $team->id)}}" method="post">
                                        ...
                                        <a href="{!! url('admin/team/'.$team->id) !!}/edit" class="btn btn-default btn-icon btn-simple btn-icon-mini btn-round"><i class="zmdi zmdi-edit m-2"></i></a>
