        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="{{ route('category.create') }}" class="btn btn-raised btn-info -mt5 btn-sm btn-round waves-effect">
                            ...
                            <tr>
                                ...
                                <td class="p-1">
                                    ...
                                    <form action="{{ route('category.destroy', $category->id)}}" method="post">
                                        ...
                                        <a href="{!! url('admin/category/'.$category->id) !!}/edit" class="btn btn-default btn-icon btn-simple btn-icon-mini btn-round"><i class="zmdi zmdi-edit m-2"></i></a>
