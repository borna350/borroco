        ...
        <div class="row clearfix">
            <div class="col-lg-7 col-md-7 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form method="post" action="{{ route('home-video.update', $data->id) }}" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
            ...
            @if( $data->image)
                <div class="col-lg-5 col-md-5 col-sm-12">
                    <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                        <a href="{{ asset('media/home-video/'. $data->image) }}">
                            <img class="img-fluid img-thumbnail" src="{{ asset('media/home-video/'. $data->image) }}" width="300">
                        </a>
                    </div>
                </div>
            @endif
